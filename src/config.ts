...
export const siteConfig: SiteConfig = {
  // Site Information
  // [CONFIG:SITE_URL]
  site: "https://www.languisher.top",
  // [CONFIG:SITE_TITLE]
  title: "LN's Blog",
  // [CONFIG:SITE_DESCRIPTION]
  description: "Depuis 2026",
  // [CONFIG:SITE_AUTHOR]
  author: "Nan Lin",
  ...
  navigation: {
    ...
    pages: [
      ...
      { title: "GitHub", url: "https://github.com/languisher" }
    ],
